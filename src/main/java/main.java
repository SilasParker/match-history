...
class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Set raph = new Set(new Match[] { raphMatch1, raphMatch2, raphMatch3, raphMatch4, raphMatch5 }, "23", "",
                "4Qs #24", date);
        ...
        // The stats thing needs to go through the match history and dynamically create
        // a list of each characters stats
